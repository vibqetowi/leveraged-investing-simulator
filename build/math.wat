(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 40268))
 (memory $0 1)
 ...
 (func $assembly/math/simulateGBM (param $0 f64) (param $1 f64) (result f64)
  (local $2 i32)
  (local $3 i64)
  (local $4 f64)
  (local $5 i32)
 ...
 (func $assembly/math/simulateMertonJump (result f64)
  call $~lib/math/NativeMath.random
 ...
 (func $assembly/math/initializeLeveragedDCA (param $0 i32) (param $1 i32)
  (local $2 f64)
  (local $3 f64)
  (local $4 f64)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/math/transitionLeveragedDCAGBMMerton (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 f64)
  (local $4 f64)
  (local $5 f64)
  (local $6 f64)
  ...
  local.get $4
  local.get $8
  call $assembly/math/simulateGBM
  call $assembly/math/simulateMertonJump
  f64.mul
  f64.mul
  call $~lib/staticarray/StaticArray<f64>#__set
  global.get $~lib/memory/__stack_pointer
