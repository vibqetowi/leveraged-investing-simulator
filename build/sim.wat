(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 40764))
 (memory $0 1)
 ...
 (func $~lib/rt/__visit_members (param $0 i32)
  block $invalid
   block $~lib/function/Function<%28~lib/staticarray/StaticArray<f64>%2C~lib/staticarray/StaticArray<f64>%29=>void>
      ...
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        block $~lib/object/Object
         ...
         i32.sub
         i32.load
         br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/staticarray/StaticArray<f64> $~lib/function/Function<%28~lib/staticarray/StaticArray<f64>%2C~lib/staticarray/StaticArray<f64>%29=>void> $invalid
        end
        return
       end
       return
 ...
 (func $assembly/math/transitionLeveragedDCAStateWithJumps (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 f64)
  (local $5 f64)
  (local $6 i64)
  ...
  block $folding-inner0
   ...
   if
    ...
    i32.const 0
    call $~lib/staticarray/StaticArray<f64>#__get
    block $__inlined_func$assembly/math/simulateMertonJumpFactor$93 (result f64)
     call $~lib/math/NativeMath.random
     ...
     if
      ...
      f64.add
      f64.sub
      br $__inlined_func$assembly/math/simulateMertonJumpFactor$93
     end
     f64.const 1
    end
    f64.mul
   ...
   local.get $0
   i32.const 2
   block $__inlined_func$assembly/math/applyMarginCall$141 (result f64)
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store offset=4
    global.get $~lib/memory/__stack_pointer
    ...
    if
     ...
     global.set $~lib/memory/__stack_pointer
     f64.const 0
     br $__inlined_func$assembly/math/applyMarginCall$141
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.store
 ...
 (func $assembly/math/transitionLeveragedDCAState (param $0 i32) (param $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
 ...
 (func $assembly/math/transitionLeveragedDCAMertonState (param $0 i32) (param $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  global.set $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/runSimulation (param $0 i32) (result i32)
  ...
  local.set $9
  global.get $~lib/memory/__stack_pointer
  block $__inlined_func$assembly/math/getSimulationMethod$99 (result i32)
   i32.const 7920
   local.get $0
   i32.eqz
   br_if $__inlined_func$assembly/math/getSimulationMethod$99
   drop
   i32.const 7952
   local.get $0
   i32.const 1
